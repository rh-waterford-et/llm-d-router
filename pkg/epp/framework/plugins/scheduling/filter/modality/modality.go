...
const (
	// ModalityFilterType is the type of the modality-based architecture filter.
	ModalityFilterType = "modality-filter"
)
...
// ModalityFilter filters endpoints based on the request path, matching only
// endpoints whose model-arch label is compatible with the requested modality.
type ModalityFilter struct {
	typedName plugin.TypedName
}

// NewModalityFilter creates a new ModalityFilter instance.
